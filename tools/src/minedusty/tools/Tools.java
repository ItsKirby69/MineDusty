...
public final class Tools{
    public static MineDustyMod thisMod;
    ...
    public static void main(String[] args){
        ...
        Reflect.<ObjectMap<Class<?>, ModMeta>>get(Mods.class, mods, "metas").put(MineDustyMod.class, meta);
