...
import minedusty.tools.Processor;
import minedusty.tools.Tools;
import minedusty.tools.GenAtlas.*;

import java.util.concurrent.*;

import static mindustry.Vars.*;
import static minedusty.tools.Tools.*;
...
public class UnitProcessor implements Processor {
    ...
    public void process(ExecutorService exec){
        content.units().select(type -> type.minfo != null && type.minfo.mod == Tools.mod).each(type -> submit(exec, type.name, () -> {
