...
public class GreenTreeBlock extends Block{
    public float shadowOffset = -4f;
    public @Load(value = "@-shadow", fallback = "") TextureRegion shadow;
	public @Load(value = "@-top", fallback = "") TextureRegion topRegion;

    public GreenTreeBlock(String name){
        super(name);
        solid = true;
        clipSize = 90;
        customShadow = true;
    ...
    public void drawBase(Tile tile){
		...
		if(topRegion.found()){
            ...
            Draw.rect(topRegion, tile.worldx(), tile.worldy());
        }
    }
